...
import (
	...
	"github.com/keepsty/go_rds/internal/common/forms"
	commonModels "github.com/keepsty/go_rds/internal/common/models"
	"github.com/keepsty/go_rds/internal/global"
	userModels "github.com/keepsty/go_rds/internal/users/models"
	"github.com/keepsty/go_rds/middleware"
	"github.com/keepsty/go_rds/pkg/notifier"
...
func (s *AdminTestNotifyConfigService) Run() error {
	...
	baseMsg := fmt.Sprintf("您好，这是一条 GoRDS 消息通知测试。\n时间：%s", now)
	...
	case "mail":
		...
		if err := emailNotifier.SendMessage("【GoRDS】消息通知测试", []string{user.Email}, baseMsg); err != nil {
