...
{% set basedir="/usr/local/mysql[[.Version ]]" %}
{% set percona_toolkit="[[.PerconaToolkit ]]" %}
{% set xtrabackup_24_rpm="[[.Xtrabackup24Rpm ]]" %}
{% set xtrabackup_24_tarball="[[.Xtrabackup24Tarball ]]" %}
{% set xtrabackup_24_tarball_dir="/usr/local/xtrabackup24" %}
{% set xtrabackup_80_rpm="[[.Xtrabackup80Rpm ]]" %}
{% set xtrabackup_80_tarball="[[.Xtrabackup80Tarball ]]" %}
