{% set proxysql_rpm='proxysql-2.0.18-1-centos7.x86_64.rpm' %}
{% set proxysql_port=6032 %}
{% set proxysql_datadir='/data/proxysql_6032' %}
{% set proxysql_conf_dir = 'node6-test-com/proxysql_6032' %}
{% set netstat_admin_port_check = 'netstat -tulpn|grep 6032 |wc -l ' %}
{% set netstat_buss_port_check = 'netstat -tulpn|grep 16032 |wc -l ' %}
{% set lsof_admin_port_check = 'lsof -i:6032 |wc -l ' %}
